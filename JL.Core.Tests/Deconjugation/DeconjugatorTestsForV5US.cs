...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    public void Deconjugate_MasuStem_V5US()
    {
        ...
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
    ...
    [Test]
    public void Deconjugate_PoliteShortCausativeAffirmative_V5US()
    {
        const string termToDeconjugate = "問わします";
    ...
    [Test]
    public void Deconjugate_PoliteShortCausativeNegative_V5US()
    {
        const string termToDeconjugate = "問わしません";
        const string expected = "～short causative→polite negative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_PlainNonPastSugiruAffirmative2_V5US()
    {
        const string termToDeconjugate = "問い過ぎる";
        const string expected = "～too much";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_ContractedProvisionalConditional_V5US()
    {
        const string termToDeconjugate = "問や";
    ...
    {
        const string termToDeconjugate = "問わさない";
    ...
    [Test]
    public void Deconjugate_PlainNonPastNegativeConditional_V5US()
    {
        const string termToDeconjugate = "問わねば";
        const string expected = "～negative conditional";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_PlainNonPastColloquialNegativeConditional_V5US()
    {
        const string termToDeconjugate = "問わにゃ";
    ...
    [Test]
    public void Deconjugate_Ntosuru_V5US()
    {
        const string termToDeconjugate = "問わんとする";
    ...
    [Test]
    public void Deconjugate_Nbakari_V5US()
    {
        const string termToDeconjugate = "問わんばかり";
    ...
    [Test]
    public void Deconjugate_Eru_V5US()
    {
        const string termToDeconjugate = "問い得る";
    ...
    [Test]
    public void Deconjugate_Eru2_V5US()
    {
        const string termToDeconjugate = "問いえる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Uru_V5US()
    {
        const string termToDeconjugate = "問いうる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masende_V5US()
    {
        const string termToDeconjugate = "問いませんで";
    ...
    [Test]
    public void Deconjugate_Masendeshite_V5US()
    {
        const string termToDeconjugate = "問いませんでして";
        const string expected = "～polite negative te";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masereba_V5US()
    {
        const string termToDeconjugate = "問いますれば";
    ...
    [Test]
    public void Deconjugate_Mase_V5US()
    {
        const string termToDeconjugate = "問いませ";
        const string expected = "～polite imperative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masendeshitara_V5US()
    {
        const string termToDeconjugate = "問いませんでしたら";
    ...
    [Test]
    public void Deconjugate_Itasu_V5US()
    {
        const string termToDeconjugate = "問い致す";
    ...
    [Test]
    public void Deconjugate_Itashimasen_V5US()
    {
        const string termToDeconjugate = "問い致しません";
    ...
    [Test]
    public void Deconjugate_Itasu2_V5US()
    {
        const string termToDeconjugate = "問いいたす";
        const string expected = "～humble";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Itashimasen2_V5US()
    {
        const string termToDeconjugate = "問いいたしません";
        const string expected = "～humble→polite negative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Temiru_V5US()
    {
        const string termToDeconjugate = "問うてみる";
    ...
    [Test]
    public void Deconjugate_Yasui_V5US()
    {
        const string termToDeconjugate = "問いやすい";
    ...
    [Test]
    public void Deconjugate_Nikui_V5US()
    {
        const string termToDeconjugate = "問いにくい";
    ...
    [Test]
    public void Deconjugate_Morau_V5US()
    {
        const string termToDeconjugate = "問うてもらう";
    ...
    [Test]
    public void Deconjugate_Yaru_V5US()
    {
        const string termToDeconjugate = "問うてやる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Sashiageru_V5US()
    {
        const string termToDeconjugate = "問うてさしあげる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "問う" && form.LastTag is "v5u-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
