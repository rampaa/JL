...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    [Test]
    public void Deconjugate_PlainNonPastSouNegative_v5us()
    {
        const string termToDeconjugate = "問わなそう";
    ...
    [Test]
    public void Deconjugate_TsutsuNegative_v5us()
    {
        const string termToDeconjugate = "問わなつつ";
