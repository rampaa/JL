...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    public void Deconjugate_MasuStem_V5KS()
    {
        ...
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
    ...
    [Test]
    public void Deconjugate_PoliteShortCausativeAffirmative_V5KS()
    {
        const string termToDeconjugate = "行かします";
    ...
    [Test]
    public void Deconjugate_PlainNonPastSugiruAffirmative2_V5KS()
    {
        const string termToDeconjugate = "行き過ぎる";
        const string expected = "～too much";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_ContractedProvisionalConditional_V5KS()
    {
        const string termToDeconjugate = "行きゃ";
    ...
    {
        const string termToDeconjugate = "行かさない";
    ...
    [Test]
    public void Deconjugate_PoliteNonPastNegativeConjectural_V5KS()
    {
        const string termToDeconjugate = "行きますまい";
    ...
    [Test]
    public void Deconjugate_PlainNonPastClassicalHypotheticalConditional_V5KS()
    {
        const string termToDeconjugate = "行かば";
    ...
    [Test]
    public void Deconjugate_PlainNonPastNegativeConditional_V5KS()
    {
        const string termToDeconjugate = "行かねば";
        const string expected = "～negative conditional";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_PlainNonPastColloquialNegativeConditional_V5KS()
    {
        const string termToDeconjugate = "行かにゃ";
    ...
    [Test]
    public void Deconjugate_Ntosuru_V5KS()
    {
        const string termToDeconjugate = "行かんとする";
    ...
    [Test]
    public void Deconjugate_Nbakari_V5KS()
    {
        const string termToDeconjugate = "行かんばかり";
    ...
    [Test]
    public void Deconjugate_Eru_V5KS()
    {
        const string termToDeconjugate = "行き得る";
    ...
    [Test]
    public void Deconjugate_Eru2_V5KS()
    {
        const string termToDeconjugate = "行きえる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Uru_V5KS()
    {
        const string termToDeconjugate = "行きうる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masende_V5KS()
    {
        const string termToDeconjugate = "行きませんで";
    ...
    [Test]
    public void Deconjugate_Masendeshite_V5KS()
    {
        const string termToDeconjugate = "行きませんでして";
        const string expected = "～polite negative te";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masereba_V5KS()
    {
        const string termToDeconjugate = "行きますれば";
    ...
    [Test]
    public void Deconjugate_Mase_V5KS()
    {
        const string termToDeconjugate = "行きませ";
        const string expected = "～polite imperative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masendeshitara_V5KS()
    {
        const string termToDeconjugate = "行きませんでしたら";
    ...
    [Test]
    public void Deconjugate_Masendeshitari_V5KS()
    {
        const string termToDeconjugate = "行きませんでしたり";
    ...
    [Test]
    public void Deconjugate_Itasu_V5KS()
    {
        const string termToDeconjugate = "行き致す";
    ...
    [Test]
    public void Deconjugate_Itashimasen_V5KS()
    {
        const string termToDeconjugate = "行き致しません";
    ...
    [Test]
    public void Deconjugate_Itasu2_V5KS()
    {
        const string termToDeconjugate = "行きいたす";
        const string expected = "～humble";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Itashimasen2_V5KS()
    {
        const string termToDeconjugate = "行きいたしません";
        const string expected = "～humble→polite negative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Temiru_V5KS()
    {
        const string termToDeconjugate = "行ってみる";
    ...
    [Test]
    public void Deconjugate_Yasui_V5KS()
    {
        const string termToDeconjugate = "行きやすい";
    ...
    [Test]
    public void Deconjugate_Nikui_V5KS()
    {
        const string termToDeconjugate = "行きにくい";
    ...
    [Test]
    public void Deconjugate_Morau_V5KS()
    {
        const string termToDeconjugate = "行ってもらう";
    ...
    [Test]
    public void Deconjugate_Yaru_V5KS()
    {
        const string termToDeconjugate = "行ってやる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Sashiageru_V5KS()
    {
        const string termToDeconjugate = "行ってさしあげる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "行く" && form.LastTag is "v5k-s").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
