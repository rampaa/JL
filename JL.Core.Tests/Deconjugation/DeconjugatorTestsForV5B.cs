...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    public void Deconjugate_MasuStem_V5B()
    {
        ...
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "選ぶ" && form.LastTag is "v5b").Select(static form => form.Process).ToList().AsReadOnlySpan());
    ...
    [Test]
    public void Deconjugate_PoliteShortCausativeAffirmative_V5B()
    {
        const string termToDeconjugate = "選ばします";
    ...
    {
        const string termToDeconjugate = "選ばさない";
    ...
    [Test]
    public void Deconjugate_PoliteNonPastNegativeConjectural_V5B()
    {
        const string termToDeconjugate = "選びますまい";
    ...
    [Test]
    public void Deconjugate_Temiru_V5B()
    {
        const string termToDeconjugate = "選んでみる";
    ...
    [Test]
    public void Deconjugate_Yasui_V5B()
    {
        const string termToDeconjugate = "選びやすい";
    ...
    [Test]
    public void Deconjugate_Nikui_V5B()
    {
        const string termToDeconjugate = "選びにくい";
    ...
    [Test]
    public void Deconjugate_Morau_V5B()
    {
        const string termToDeconjugate = "選んでもらう";
    ...
    [Test]
    public void Deconjugate_Yaru_V5B()
    {
        const string termToDeconjugate = "選んでやる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "選ぶ" && form.LastTag is "v5b").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Sashiageru_V5B()
    {
        const string termToDeconjugate = "選んでさしあげる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "選ぶ" && form.LastTag is "v5b").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
