...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    public void Deconjugate_MasuStem_V5T()
    {
        ...
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
    ...
    [Test]
    public void Deconjugate_PoliteShortCausativeAffirmative_V5T()
    {
        const string termToDeconjugate = "育たします";
    ...
    [Test]
    public void Deconjugate_PlainNonPastSugiruAffirmative2_V5T()
    {
        const string termToDeconjugate = "育ち過ぎる";
        const string expected = "～too much";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_ContractedProvisionalConditional_V5T()
    {
        const string termToDeconjugate = "育ちゃ";
    ...
    {
        const string termToDeconjugate = "育たさない";
    ...
    [Test]
    public void Deconjugate_PoliteNonPastNegativeConjectural_V5T()
    {
        const string termToDeconjugate = "育ちますまい";
    ...
    [Test]
    public void Deconjugate_PlainNonPastClassicalHypotheticalConditional_V5T()
    {
        const string termToDeconjugate = "育たば";
    ...
    [Test]
    public void Deconjugate_PlainNonPastNegativeConditional_V5T()
    {
        const string termToDeconjugate = "育たねば";
        const string expected = "～negative conditional";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_PlainNonPastColloquialNegativeConditional_V5T()
    {
        const string termToDeconjugate = "育たにゃ";
    ...
    [Test]
    public void Deconjugate_Ntosuru_V5T()
    {
        const string termToDeconjugate = "育たんとする";
    ...
    [Test]
    public void Deconjugate_Nbakari_V5T()
    {
        const string termToDeconjugate = "育たんばかり";
    ...
    [Test]
    public void Deconjugate_Eru_V5T()
    {
        const string termToDeconjugate = "育ち得る";
    ...
    [Test]
    public void Deconjugate_Eru2_V5T()
    {
        const string termToDeconjugate = "育ちえる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Uru_V5T()
    {
        const string termToDeconjugate = "育ちうる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masende_V5T()
    {
        const string termToDeconjugate = "育ちませんで";
    ...
    [Test]
    public void Deconjugate_Masendeshite_V5T()
    {
        const string termToDeconjugate = "育ちませんでして";
        const string expected = "～polite negative te";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masereba_V5T()
    {
        const string termToDeconjugate = "育ちますれば";
    ...
    [Test]
    public void Deconjugate_Mase_V5T()
    {
        const string termToDeconjugate = "育ちませ";
        const string expected = "～polite imperative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Mashi_V5T()
    {
        const string termToDeconjugate = "育ちまし";
        const string expected = "～polite imperative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Masendeshitara_V5T()
    {
        const string termToDeconjugate = "育ちませんでしたら";
    ...
    [Test]
    public void Deconjugate_Masendeshitari_V5T()
    {
        const string termToDeconjugate = "育ちませんでしたり";
    ...
    [Test]
    public void Deconjugate_Itasu_V5T()
    {
        const string termToDeconjugate = "育ち致す";
    ...
    [Test]
    public void Deconjugate_Itashimasen_V5T()
    {
        const string termToDeconjugate = "育ち致しません";
    ...
    [Test]
    public void Deconjugate_Itasu2_V5T()
    {
        const string termToDeconjugate = "育ちいたす";
        const string expected = "～humble";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Itashimasen2_V5T()
    {
        const string termToDeconjugate = "育ちいたしません";
        const string expected = "～humble→polite negative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Temiru_V5T()
    {
        const string termToDeconjugate = "育ってみる";
    ...
    [Test]
    public void Deconjugate_Yasui_V5T()
    {
        const string termToDeconjugate = "育ちやすい";
    ...
    [Test]
    public void Deconjugate_Nikui_V5T()
    {
        const string termToDeconjugate = "育ちにくい";
    ...
    [Test]
    public void Deconjugate_Morau_V5T()
    {
        const string termToDeconjugate = "育ってもらう";
    ...
    [Test]
    public void Deconjugate_Yaru_V5T()
    {
        const string termToDeconjugate = "育ってやる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Sashiageru_V5T()
    {
        const string termToDeconjugate = "育ってさしあげる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form is { Text: "育つ", LastTag: "v5t" }).Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
