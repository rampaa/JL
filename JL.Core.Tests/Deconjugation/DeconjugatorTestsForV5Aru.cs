...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    [Test]
    public void Deconjugate_PlainNonPastSouNegative_v5aru()
    {
        const string termToDeconjugate = "仰らなそう";
    ...
    [Test]
    public void Deconjugate_TsutsuNegative_v5aru()
    {
        const string termToDeconjugate = "仰いなつつ";
    ...
    [Test]
    public void Deconjugate_ContractedProvisionalConditionalRya_v5aru()
    {
    ...
    {
        const string termToDeconjugate = "仰らささない";
