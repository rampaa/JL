...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    public void Deconjugate_MasuStem_VZ()
    {
        ...
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
    ...
    {
        const string termToDeconjugate = "命ずりゃ";
    ...
    {
        const string termToDeconjugate = "命じますまい";
    ...
    {
        const string termToDeconjugate = "命ぜにゃ";
    ...
    {
        const string termToDeconjugate = "命ぜんとする";
    ...
    {
        const string termToDeconjugate = "命ぜんばかり";
    ...
    {
        const string termToDeconjugate = "命じ得る";
    ...
    {
        const string termToDeconjugate = "命じえる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        const string termToDeconjugate = "命じうる";
        const string expected = "～be able to";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        const string termToDeconjugate = "命じませんで";
    ...
    {
        const string termToDeconjugate = "命じませんでして";
        const string expected = "～polite negative te";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        const string termToDeconjugate = "命じますれば";
    ...
    {
        const string termToDeconjugate = "命じませ";
        const string expected = "～polite imperative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        const string termToDeconjugate = "命じ致す";
    ...
    {
        const string termToDeconjugate = "命じ致しません";
    ...
    {
        const string termToDeconjugate = "命じいたす";
        const string expected = "～humble";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    {
        const string termToDeconjugate = "命じいたしません";
        const string expected = "～humble→polite negative";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Temiru_VZ()
    {
        const string termToDeconjugate = "命じてみる";
    ...
    [Test]
    public void Deconjugate_Yasui_VZ()
    {
        const string termToDeconjugate = "命じやすい";
    ...
    [Test]
    public void Deconjugate_Nikui_VZ()
    {
        const string termToDeconjugate = "命じにくい";
    ...
    [Test]
    public void Deconjugate_Morau_VZ()
    {
        const string termToDeconjugate = "命じてもらう";
    ...
    [Test]
    public void Deconjugate_Yaru_VZ()
    {
        const string termToDeconjugate = "命じてやる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
    ...
    [Test]
    public void Deconjugate_Sashiageru_VZ()
    {
        const string termToDeconjugate = "命じてさしあげる";
        const string expected = "～do for someone";
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "命ずる" && form.LastTag is "vz").Select(static form => form.Process).ToList().AsReadOnlySpan());
        Assert.That(actual, Is.EqualTo(expected));
    }
