...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
{
    ...
    public void Deconjugate_MasuStem_V5S()
    {
        ...
        string? actual = LookupResultUtils.DeconjugationProcessesToText(Deconjugator.Deconjugate(termToDeconjugate).Where(static form => form.Text is "壊す" && form.LastTag is "v5s").Select(static form => form.Process).ToList().AsReadOnlySpan());
