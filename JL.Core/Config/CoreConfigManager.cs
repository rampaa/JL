...
public sealed class CoreConfigManager
{
    ...
    private void ApplyAnkiUriSetting(SqliteConnection connection, Dictionary<string, string> configs)
    {
    ...
    private void ApplyWebSocketSettings(SqliteConnection connection, Dictionary<string, string> configs)
    {
    ...
    public void ApplyPreferences(SqliteConnection connection, Dictionary<string, string> configs)
    {
        ...
        ApplyAnkiUriSetting(connection, configs);
        ApplyTsukikageSettings(connection, configs);
        ApplyWebSocketSettings(connection, configs);
