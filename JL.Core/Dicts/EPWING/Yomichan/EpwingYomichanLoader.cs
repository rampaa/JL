...
internal static class EpwingYomichanLoader
{
    ...
    public static EpwingYomichanRecord? GetEpwingYomichanRecord(List<JsonElement> jsonElements, Dict dict)
    {
        ...
        string[]? definitions = EpwingYomichanUtils.GetDefinitions(jsonElements[5], dict);
    ...
    {
        string primarySpellingInHiragana = dict.Type is not DictType.NonspecificKanjiWithWordSchemaYomichan and not DictType.KanjigenYomichan
