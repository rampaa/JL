...
internal sealed class DBParameters(List<string>? allTextWithoutLongVowelMark,
    string? jmdictWordQuery,
    string? jmdictVerbQuery,
    string? jmnedictQuery,
    ...
    string? jmdictTextWithoutLongVowelMarkParameter) : IEquatable<DBParameters>
{
    ...
    public string? JmdictWordQuery { get; } = jmdictWordQuery;
    public string? JmdictVerbQuery { get; } = jmdictVerbQuery;
    public string? JmnedictQuery { get; } = jmnedictQuery;
