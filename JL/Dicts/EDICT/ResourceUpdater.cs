...
namespace JapaneseLookup.Dicts.EDICT
{
    public static class ResourceUpdater
    {
        ...
        {
            if (!isUpdate || MessageBox.Show($"Do you want to download the latest version of {resourceName}?",
                "Update dictionary?", MessageBoxButton.YesNo, MessageBoxImage.Question, MessageBoxResult.Yes,
                MessageBoxOptions.DefaultDesktopOnly) == MessageBoxResult.Yes)
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (!noPrompt)
                        MessageBox.Show($"{resourceName} has been downloaded successfully.", "", MessageBoxButton.OK,
                ...
                {
                    MessageBox.Show($"{resourceName} is up to date.", "", MessageBoxButton.OK,
                        MessageBoxImage.Information, MessageBoxResult.OK, MessageBoxOptions.DefaultDesktopOnly);
                }

                else if (!noPrompt)
                {
                    MessageBox.Show($"Unexpected error while downloading {resourceName}.", "", MessageBoxButton.OK,
                        MessageBoxImage.Information, MessageBoxResult.OK, MessageBoxOptions.DefaultDesktopOnly);
                }
            }
